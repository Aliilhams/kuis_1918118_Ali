package com.example.Ali_1918118;
...
public class CustomListAdapter extends BaseAdapter {
    ...
    private List<com.example.Ali_1918118.Mahasiswa> Mahasiswa;
    public CustomListAdapter(Activity activity, List<com.example.Ali_1918118.Mahasiswa> Mahasiswa) {
    ...
    public View getView(int position, View convertView, ViewGroup
        ...
        com.example.Ali_1918118.Mahasiswa m = Mahasiswa.get(position);
